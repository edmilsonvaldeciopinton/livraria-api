...
class AutorServiceTest {
	...
	void deveriaCadastrarUmAutor() {
		AutorFormDto formAutorDto = new AutorFormDto("Fulano de Tal", "fulano@gmail.com", LocalDate.now(),
				"Analista de RH", 1l);
	...
	@Test
	void naodeveriaCadastrarUmAutorComUsuarioInexistente() {
		AutorFormDto formAutorDto = new AutorFormDto("Fulano de Tal", "fulano@gmail.com", LocalDate.now(),
				"Analista de RH", 999999l);
